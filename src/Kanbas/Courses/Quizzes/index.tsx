        ...
        <div>
          ...
          <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li><a className="dropdown-item" href="google.com" onClick={() => handleDeleteAll()}>Delete All Quizzes</a></li>
              <li><a className="dropdown-item" href="google.com" onClick={() => handlePublishAll(true)}>Publish All</a></li>
              <li><a className="dropdown-item" href="goodle.com" onClick={() => handlePublishAll(false)}>Unpublish All</a></li>
            </ul>
        </div>
      </div>
      <hr />
