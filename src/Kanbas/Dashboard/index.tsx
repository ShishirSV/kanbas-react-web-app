...
export default function Dashboard({ courses, course, setCourse, addNewCourse,
  ...
  return (
    <div id="wd-dashboard">
      ...
      <input value={course.startDate} className="form-control mb-2" onChange={(e) => setCourse({ ...course, startDate: e.target.value }) } />
      <input value={course.endDate} className="form-control mb-2" onChange={(e) => setCourse({ ...course, endDate: e.target.value }) } />
      <hr />
