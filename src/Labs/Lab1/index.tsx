...
to summarize the topic of the section it precedes. HTML heading tags can 
...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-starship" width="400px" src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" alt="Star Ship"/>
        <br />
        Loading a local image: <br />
        <img id="wd-teslabot" src="/images/random-country.jpg" height="200px" alt="Random Country"/>
      </div>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input id="wd-text-fields-last-name" type="text" placeholder="Doe"
